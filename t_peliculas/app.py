...
def cargar_datos():
    ...
    for item in response['Items']:
        ...
        data.append([cinema_id, title, genre, duration, rating])
    return data
...
def guardar_en_s3(data, filename):
    ...
    with open(filename, mode='w', newline='') as file:
        ...
        writer.writerow(["cinema_id", "title", "genre", "duration", "rating"])
...
def ingesta_datos():
    data = cargar_datos()
    guardar_en_s3(data, 't_peliculas_data.csv')
